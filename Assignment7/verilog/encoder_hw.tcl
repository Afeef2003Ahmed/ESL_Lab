...
set_module_property NAME encoder_ip_demo
set_module_property VERSION 1.0
set_module_property GROUP Templates
set_module_property AUTHOR student
set_module_property DISPLAY_NAME encoder_ip
set_module_property TOP_LEVEL_HDL_FILE encoder_wrapper.v
set_module_property TOP_LEVEL_HDL_MODULE encoder_wrapper
...
##  
add_file encoder_wrapper.v {SYNTHESIS SIMULATION}
...
add_interface encoder_interface conduit end
add_interface_port encoder_interface enc_a export Input 1
add_interface_port encoder_interface enc_b export Input 1

add_interface user_interface conduit end
add_interface_port user_interface led_out export Output -1
##
## - Validation/ elaboration functions
##
proc validate_me {} {
...
proc elaborate_me {}  {
  ...
  set_port_property led_out WIDTH $the_led_width
